...
REQUIRED_FILES = [
    ...
    ".testagent/agents/test-e2e-analysis-design-agent.md",
    ".testagent/commands/test-analysis-workflow.md",
    ".testagent/commands/test-analysis-design-workflow.md",
    ...
    "docs/agents/test-analysis-agent.md",
    "docs/agents/test-design-agent.md",
    "docs/agents/test-e2e-analysis-design-agent.md",
    "docs/architecture/framework-overview.md",
    "docs/architecture/output-artifact-contract.md",
    "docs/architecture/knowledge-rules-memory-boundaries.md",
    "docs/archive/skills-architecture-optimization-analysis.md",
    ...
    "knowledge/test-case-writing-styles/gui-test-case-style.md",
    "knowledge/test-case-writing-styles/api-test-case-style.md",
    "knowledge/test-case-writing-styles/cli-test-case-style.md",
    ...
    "templates/fact-coverage-map-json-template.json",
    ...
    "skills/test-analysis-design-workflow/SKILL.md",
    ...
    "skills/final-report-generation/SKILL.md",
    ...
    "bin/build-final-report.py",
    "bin/build-fact-coverage-map.py",
    "bin/apply-coverage-gaps.py",
    "bin/apply-review-findings.py",
    "bin/check-staged-run.py",
    "bin/update-run-task.py",
    "skills/test-analysis-solution-generation/scripts/extract-test-point-work-items.py",
    "skills/test-analysis-solution-generation/scripts/init-test-point-slice.py",
    "bin/init-staged-slices.py",
