...
SCOPES = {
    "analysis": StageScope(
        ...
        review_dir_relative="reports/test-point-reviews",
        init_script="bin/init-test-point-slice.py",
        init_id_arg="--leaf-sc",
        merge_script="bin/merge-test-point-slice.py",
    ...
    "design": StageScope(
        ...
        review_dir_relative="reports/test-case-reviews",
        init_script="bin/init-test-case-slice.py",
        init_id_arg="--tp",
        merge_script="bin/merge-test-case-slice.py",
