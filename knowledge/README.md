...
| 标准层 | `testpoint-standard.md`、`test-analysis-solution-standard.md`、`test-design-solution-standard.md`、`test-case-writing-standard.md` | 定义 SC/TP/TC 字段、粒度、编号、追踪、公共用例写作和保守预期标准 |
| 测试用例写作风格层 | `test-case-writing-styles/` | 定义 GUI、API、CLI 测试用例在 canonical JSON 中的字段级写作风格 |
