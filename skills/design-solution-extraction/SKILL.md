...
description: 当用户提供设计方案文档时使用。负责从设计方案中提取接口、字段、状态、权限、数据依赖、配置、异常处理、非功能约束和设计缺口，形成可供方法路由、测试点生成和标题项生成消费的设计事实摘要。
---
...
10. 按 `templates/design-facts-template.md` 输出设计事实摘要，交给方法路由、测试点生成和标题项生成使用。
