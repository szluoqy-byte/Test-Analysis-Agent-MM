...
description: 在测试设计方案生成后使用，用于执行覆盖审查、需求追踪检查、测试技术应用检查、输出结构检查、测试设计项粒度检查、预期结果依据检查和非完整用例化检查。
---

# 覆盖审查 Skill

本 skill 在测试设计方案输出前使用，是自我评审和迭代修正入口。
...
| 结果 | 含义 | 后续处理 |
|---|---|---|
| 通过 | 结构、追踪、测试技术应用、设计项粒度和语义质量满足要求 | 可以输出测试设计方案 |
...
- 测试点是否保持非用例化，测试设计项是否保持代表性条件、数据、状态或组合粒度。
