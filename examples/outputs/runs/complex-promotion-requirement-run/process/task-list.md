...
|---|---|---|---|---|---|
| 1 | 固定 PROJECT_ROOT 与运行目录 | analyze-requirement-testcase-outline | outputs/runs/complex-promotion-requirement-run/ | done | examples/outputs/runs/complex-promotion-requirement-run/ |
